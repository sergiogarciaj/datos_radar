...
concat(agent_action_description, call_reason, resolution_status) as text
...
and voicebot_category_process in (/*"CHECK_IN_ERROR","CHECK_IN_REQUEST"*/"SEAT_ASSIGNMENT_PROBLEM")
